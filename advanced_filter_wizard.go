...
func (afw *AdvancedFilterWizard) CreateAdvancedFilter() (filters.AdvancedFilter, error) {
	...
	choice := wizard.GetChoice(afw.reader, 1, 5, "Choose creation method: ")
...
func (afw *AdvancedFilterWizard) createEC2PrebuiltFilter(
	...
	choice := wizard.GetChoice(afw.reader, 1, 6, "Choose EC2 pattern: ")
...
func (afw *AdvancedFilterWizard) createS3PrebuiltFilter(
	...
	choice := wizard.GetChoice(afw.reader, 1, 5, "Choose S3 pattern: ")
...
func (afw *AdvancedFilterWizard) createRDSPrebuiltFilter(
	...
	choice := wizard.GetChoice(afw.reader, 1, 5, "Choose RDS pattern: ")
...
func (afw *AdvancedFilterWizard) createLambdaPrebuiltFilter(
	...
	choice := wizard.GetChoice(afw.reader, 1, 4, "Choose Lambda pattern: ")
...
func (afw *AdvancedFilterWizard) createEBSPrebuiltFilter(
	...
	choice := wizard.GetChoice(afw.reader, 1, 4, "Choose EBS pattern: ")
...
func (afw *AdvancedFilterWizard) createIAMPrebuiltFilter(
	...
	choice := wizard.GetChoice(afw.reader, 1, 3, "Choose IAM pattern: ")
...
func (afw *AdvancedFilterWizard) createGenericPrebuiltFilter(
	...
	choice := wizard.GetChoice(afw.reader, 1, 3, "Choose generic pattern: ")
...
func (afw *AdvancedFilterWizard) createComplexFilter() (filters.AdvancedFilter, error) {
	...
	choice := wizard.GetChoice(afw.reader, 1, 4, "Choose logic type: ")
...
func (afw *AdvancedFilterWizard) createANDFilter() (filters.AdvancedFilter, error) {
	...
	for {
		...
		choice := wizard.GetChoice(afw.reader, 1, maxChoices, "Choose action: ")
...
func (afw *AdvancedFilterWizard) browseAndCustomizeExamples() (filters.AdvancedFilter, error) {
	...
	choice := wizard.GetChoice(afw.reader, 1, len(exampleNames), "Choose example to customize: ")
	...
	actionChoice := wizard.GetChoice(afw.reader, 1, 3, "Choose action: ")
...
func (afw *AdvancedFilterWizard) selectField(resourceDef resources.ResourceDefinition) string {
	...
	choice := wizard.GetChoice(afw.reader, 1, len(fieldNames), "Enter field number: ")
...
func (afw *AdvancedFilterWizard) selectOperator(fieldDef resources.FieldDefinition) string {
	...
	choice := wizard.GetChoice(afw.reader, 1, len(fieldDef.Operators), "Choose operator: ")
